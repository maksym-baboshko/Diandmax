...
export function Hero() {
  ...
  return (
    <SectionWrapper id="hero" fullHeight noPadding className="relative overflow-hidden">
      <div className="relative flex min-h-screen w-full flex-col items-center justify-between py-12 md:pb-8 md:pt-24">
        ...
        {liteMotion ? (
          ...
          <>
            <div className="relative z-10 flex w-full max-w-6xl flex-1 flex-col items-center justify-center px-4">
              <AnimatedReveal direction="down" delay={0.1}>
                <h1 className="heading-serif mb-10 text-center text-6xl leading-[0.9] text-text-primary sm:text-7xl md:mb-16 md:text-7xl lg:text-8xl xl:text-[100px]">
                  <span className="hidden whitespace-nowrap md:inline-block">
                    {t("groom_name")} <span className="text-accent italic">&</span>{" "}
                    {t("bride_name")}
                  </span>
                  <span className="flex flex-col items-center leading-tight md:hidden">
                    <span>{t("groom_name")}</span>
            ...
            <AnimatedReveal direction="up" delay={0.9} className="relative z-10 w-full flex-none">
