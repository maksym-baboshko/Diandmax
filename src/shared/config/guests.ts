...
export const guests: Guest[] = [
  ...
  {
    slug: 'oleksandr-nila',
    name: { uk: 'Дідусь Олександр та бабуся Ніла', en: 'Grandpa Oleksandr and Grandma Nila' },
    vocative: { uk: 'Дідусю Олександре та бабусю Ніло', en: 'Grandpa Oleksandr and Grandma Nila' },
